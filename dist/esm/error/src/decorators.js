        ...
        return class extends constructor {
            ...
            applyAutoTransform(opts) {
                ...
                methods.forEach((methodName) => {
                    ...
                    if (isAsync) {
                        this[methodName] = errorTransformer.withAsyncTransform(originalMethod.bind(this), { methodName, ...opts === null || opts === void 0 ? void 0 : opts.defaultContext });
                    }
                    else {
                        this[methodName] = errorTransformer.withSyncTransform(originalMethod.bind(this), { methodName, ...opts === null || opts === void 0 ? void 0 : opts.defaultContext });
                    }
                });
            }
        };
