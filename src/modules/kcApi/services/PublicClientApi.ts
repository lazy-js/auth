...
export class PublicClientApi implements IPublicClientApi {
     ...
     */
    async addChildRole(
        payload: Required<AddRolePayload>,
    ): Promise<AddRoleReturn> {
     ...
     */
    async getRolesByClientUuid(
        clientUuid: string,
    ): Promise<GetRolesByClientUuidReturn> {
     ...
     */
    async getRoleByName(
        paylaod: GetRoleByNamePayload,
    ): Promise<GetRoleByNameReturn> {
        return (await this.getRolesByClientUuid(paylaod.clientUuid)).find(
     ...
     * }
     */
    async getRolesByParentId(
        payload: GetRolesByParentIdPayload,
    ): Promise<GetRolesByParentIdReturn> {
