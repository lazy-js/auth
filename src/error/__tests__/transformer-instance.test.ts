                ...
                describe("ErrorInstance output type", () => {
                        ...
                        it("should preserve error instance properties", () => {
                                ...
                                try {
                                        ...
                                        expect((thrownError as ValidationError).label).toBe("Validation failed");
                                }
                        });
                });
                ...
                describe("ErrorInstance with replaceConstructor", () => {
                                ...
                                mockErrorMap = [
                                        {
                                                ...
                                                output: {
                                                        type: "ErrorInstance",
                                                        error: conflictError,
                                                        replaceConstructor: ErrorConstructorMap.NotFoundError,
                                                },
                                        },
                                ];
                                errorTransformer = new ErrorTransformer(mockErrorMap, defaultError);
                        ...
                        it("should merge context when replacing constructor", () => {
                                ...
                                try {
                                        ...
                                        expect((thrownError as NotFoundError).context).toMatchObject(context);
                                }
                        });
                });
        });
